...
namespace Easy.Admin.SpaServices.Npm
{
    internal class NpmScriptRunner
    {
        ...
        public NpmScriptRunner(string workingDirectory,string npmExe, string scriptName, string arguments, IDictionary<string, string> envVars)
        {
